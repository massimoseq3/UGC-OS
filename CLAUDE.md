...
| Tools | Ad Analyzer | `ad-anatomy/` | Ad image or video frame → Breakdown (scorecard + hook / angle / structure + a product-agnostic Script Style Prompt, saveable to the Script Bank as `kind: 'style'`) + transcript + visual playbook |
