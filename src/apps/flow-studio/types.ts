...
export interface VoiceoverNodeConfig { voiceId: string; voiceName: string }
export interface BrollNodeConfig { aspectRatio: '9:16' | '16:9'; maxScenes: number }
export interface ImageNodeConfig { prompt: string; modelId: string; aspectRatio: AspectRatio }
