        ...
        fields: [
          ...
          },
          {
            ...
            chips: [
              ...
              'Influencer ring light, bright and even with clear catchlights in the eyes',
...
export const PRESET_YUKI: CharacterProfile = {
  ...
  lighting: 'Influencer ring light, bright and even with clear catchlights in the eyes',
  weather: 'Indoor (N/A)',
  timeOfDay: 'Evening',
  pose: 'Front-on facing camera',
