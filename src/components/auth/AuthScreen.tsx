  ...
  return (
    <AuthShell subtitle={SUBTITLES[mode]}>
      <AuthForm onSubmit={handleSubmit}>
        ...
        {needsConfirm && <AuthNotice tone="ok">Check your inbox to confirm your email, then sign in.</AuthNotice>}

        {/* Deliberately says "if" — confirming which addresses have an
            account would answer that question for anyone who asked. */}
        {resetSent && (
          <AuthNotice tone="ok">If that email has an account, a reset link is on its way. The link lasts an hour.</AuthNotice>
        )}
