  ...
  return (
    <LegalLayout title="Privacy Policy">
      ...
      <UL>
        ...
        <li>
          <strong>Usage</strong>: which tools you open and how long you spend in each, counted only
          while you are active in the tab.
        </li>
        <li>
          <strong>Error reports</strong>: when something fails, the error message and technical
          details (the tool you were in, the page, your browser and screen size, the app version,
          and the last few tools you opened). Your API keys and media are never included. Error
          reports are on by default and can be switched off in Settings → Account.
        </li>
      </UL>
      ...
      <UL>
        ...
        <li>To find and fix bugs, using error reports and usage data.</li>
      ...
      <UL>
        ...
        <li>Usage data and error reports: retained while your account is active.</li>
